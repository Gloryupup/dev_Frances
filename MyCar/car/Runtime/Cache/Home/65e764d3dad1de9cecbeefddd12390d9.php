...
<html>
  ...
  <head>
    <meta charset="UTF-8">
    <title>登陆验证</title>
    <link rel="stylesheet" href="/Mycar/Public/Style/login.css"></head>
    ...
    <div class="section-center">
      <div class="container">
        ...
        <div class="cover action">
          <form method="post" action="<?php echo U('User/login');?>" class="container">
            <ul>
              <li>
                <input type="text" name="username" placeholder="用户名"></li>
              <li>
                <input type="password" name="password" placeholder="密码"></li>
              <li>
                <button type="button" class="login-button">
                  <a href="<?php echo U('logup');?>" style="text-decoration: none; color: #000;">申请注册</a></button>
                <button type="submit" class="login-button">登陆</button></li>
            </ul>
          </form>
        </div>
      </div>
