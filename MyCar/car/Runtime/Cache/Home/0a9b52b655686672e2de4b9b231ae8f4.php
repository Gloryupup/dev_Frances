...
<div id="product-header">
    <div class="container">
      <form method="post" action="<?php echo U('Index/product');?>">
        <ul class="select">
            <li class="select-list">
                <dl id="select1">
                    <dd class="classification">车型：</dd>
                    <dd><a href="<?php echo U('Index/product',array('type'=>"all"));?>" onclick="inital()">全部</a></dd>
                    <dd><a href="<?php echo U('Index/product',array('type'=>"little"));?>" onclick="inital()">小型</a></dd>
                    <dd><a href="<?php echo U('Index/product',array('type'=>"medium"));?>" onclick="inital()">中型SUV</a></dd>
                    <dd><a href="<?php echo U('Index/product',array('type'=>"medium-long"));?>" onclick="inital()">中长型</a></dd>
                    <dd><a href="<?php echo U('Index/product',array('type'=>"long"));?>" onclick="inital()">全尺寸</a></dd>
                </dl>
            </li>
            <li class="select-list">
                <dl id="select2" >
                    <dd class="classification">车名：
                    <?php if(is_array($salename)): $i = 0; $__LIST__ = $salename;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><dd ><a href="<?php echo U('Index/product',array('name'=>$vo,'type'=>$type));?>" onclick="inital()"><?php echo ($vo); ?></a></dd><?php endforeach; endif; else: echo "" ;endif; ?>
                    </dd>
                </dl>
            </li>
            <li class="select-list">
...
<div id="product">
    ...
    <div class="container">
        ...
        <div class="picture">
            ...
            <a href="<?php echo U('Login/isLogin',array('download'=>"sale"));?>" ><h5>下载数据</h5></a>
        </div>
    </div>
</div>      
...
<script >
    ...
    var saledate=<?php echo ($saledate); ?>,sale=<?php echo ($sale); ?>;
    option = {
        title:{
             text:'舆情综合指数',
             textStyle:{
